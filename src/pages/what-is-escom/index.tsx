		...
		<div className="min-h-screen px-6 py-8 md:px-12 lg:px-24 pt-16">
			<div>
				...
				<div className="flex flex-col gap-24 animate-[fadeIn_0.4s_ease-out]">
					...
					{/* Section: Contractors */}
					<section id="contractors" className="relative pb-32">
						<img
					...
					<section id="asteroid-attack" className="relative pb-32">
						<img
					...
					<section id="escom-initiative" className="relative pb-32">
						<img
							src="/images/background/treath.png"
							alt=""
							className="absolute right-0 top-16 w-[600px] md:w-[750px] h-auto object-contain opacity-30 pointer-events-none"
						...
						<div className="relative z-10 p-6 md:p-8">
							...
							<div className="flex flex-col gap-4 max-w-[60%]">
								<p className="text-white/80 text-sm md:text-base leading-relaxed">
									Under the leadership of the W.A.R.D. Directorate and a coalition of allied
									corporations, construction of the ESCOM Assembly Dome is already underway.
